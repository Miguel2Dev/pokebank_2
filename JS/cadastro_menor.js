document.addEventListener("DOMContentLoaded", function() {
    const cpfInput = document.querySelector('input[placeholder="CPF do Responsável"]');
    const telefoneInput = document.querySelector('input[placeholder="Telefone do Responsável"]');
    const botao = document.querySelector('.botao-concluir');
